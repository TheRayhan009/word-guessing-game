...
|                                                                                                           |
|                                      You have random chance to guess.                                      |
|                                                                                                           |
|                                         username is : "{os.getlogin().lower()}"                                           |
|                                                                                                           |
|                                                 --info--                                                  |
|                                        The game made by TheRayhan PY .                                    |
|                                    Building programming language is python.                               |
|                                                 ENJOY!!                                                   |
...
def rendomst():
    ...
    print("\t \t \t \t \t  Your Guessing Chance Is :", chanch)
...
while x < na:
    ...
    if bulchak == True:
        ...
        if pchak == "y" or pchak.lower() == "y":
            ...
            coc = True
            print("Good Bye Play With Me Later..!")
            break
    if x == na:
        coc = False
        break
